...
SD_Error SD_Init(void)
{
  __IO SD_Error errorstatus = SD_OK;
	...
	NVIC->IP[ SDIO_IRQn ] = 1;	// NVIC_IRQChannelPreemptionPriority = 1
	NVIC->ISER[ SDIO_IRQn >> 5 ] = 1 << ( SDIO_IRQn & 0x1F);	// NVIC_IRQChannelCmd = ENABLE
	//
	NVIC->IP[ SD_SDIO_DMA_IRQn ] = 2;	// NVIC_IRQChannelPreemptionPriority = 2
	NVIC->ISER[ SD_SDIO_DMA_IRQn >> 5 ] = 1 << ( SD_SDIO_DMA_IRQn & 0x1F);	// NVIC_IRQChannelCmd = ENABLE
